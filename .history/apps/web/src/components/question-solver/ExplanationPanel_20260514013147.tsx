    ...
    <div className="explanation-panel glass-card">
      ...
      {explanation && (
        <>
          ...
          <div className="explanation-meta" style={{ marginTop: '1.5rem', display: 'flex', gap: '8px', borderTop: '1px solid var(--color-border)', paddingTop: '1rem' }}>
            <span className="ai-badge" style={{ background: 'var(--color-bg-workspace)', padding: '4px 8px', borderRadius: '4px', fontSize: '0.8rem', color: 'var(--color-text-secondary)' }}>🤖 AI-Generated</span>
