...
export function TutorChat() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-120px)] rounded-xl overflow-hidden border border-slate-700/50 bg-gradient-to-br from-slate-900 via-slate-900 to-slate-800">
      {/* Header */}
